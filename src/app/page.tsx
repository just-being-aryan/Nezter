          ...
          <ContainerScroll
            titleComponent={
              <div className="flex items-center flex-col">
                ...
                <h1 className = "text-5xl md:text-8xl pb-10 bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-600 font-sans font-bold">
                  Automate your work with Nezter
                </h1>
              </div>
            }
            ></ContainerScroll>
